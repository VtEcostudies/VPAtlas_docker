...
- **Fourteen patch versions today** — `manifest.json` 3.5.244 → 3.5.245 for the pool-ID clear-X / no-zoom changes, 3.5.247 → 3.5.248 for the visit-detail dual marker, 3.5.248 → 3.5.249 for the My Visits pool-status badge, 3.5.249 → 3.5.250 for the Edit Visit mapped-circle, 3.5.250 → 3.5.251 for the Atlas Visit map button split, 3.5.251 → 3.5.252 for the pool halo + upload validation, 3.5.252 → 3.5.253 for the auto-clear error + edited-visit indicator, 3.5.253 → 3.5.254 for the edit-aware Review filter, 3.5.254 → 3.5.255 for the edit-save-draft fix + edited-pill removal, 3.5.255 → 3.5.256 for the server+edited dual pill, 3.5.256 → 3.5.257 for the visit-location-centered open, 3.5.257 → 3.5.258 for the single-setView-per-open fix, 3.5.258 → 3.5.259 for on-demand-only GPS, 3.5.259 → 3.5.260 for the visit-tooltip undefined fix (intermediate bumps came from 05-11 carry-over work).
